...
export default function TamilNaduBranch() {
  ...
  const whatsappNumber = "919035064013";
  const whatsappMessage =
    "Hello IqueCap Tamil Nadu Team, I would like to know more about investment opportunities.";
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white px-6">
            <h1 className="text-5xl font-bold">
              Invest in Tamil Nadu’s Future — With IqueCap
            </h1>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="prose prose-lg text-gray-600 space-y-6">
                ...
                <p>
                  ...
                  connecting passionate investors with high-potential private
                  ...
                  in the growth of tomorrow’s leading businesses across Tamil Nadu and India.
                </p>
                ...
                <div>
                  ...
                  <p>
                    Tamil Nadu is one of India’s strongest industrial and innovation
                    ecosystems, with Chennai, Coimbatore, Madurai, and Hosur
                    driving growth across manufacturing, technology, healthcare,
                    and renewable energy. IqueCap Tamil Nadu connects investors
                    with curated early-stage and private equity opportunities
                    rooted in the state’s powerful industrial base.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Technology & Software Ventures</li>
                    <li>Manufacturing & Industrial Innovation</li>
                    <li>Healthcare & Renewable Energy Enterprises</li>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        Access opportunities rooted in one of India’s strongest manufacturing hubs.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        Invest early in businesses shaping Tamil Nadu’s economic future.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        Expand beyond traditional investments into private equity and startups.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm">
                        Blend industrial strength with modern innovation for scalable growth.
                      </p>
                    </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">Tamil Nadu, India</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">Industrial & Technology Ventures</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-purple-500 rounded-2xl shadow-xl p-6 text-white text-center">
              ...
              <p className="text-sm mb-4 opacity-90">
                Become a member now — and be part of Tamil Nadu’s investment growth story.
              </p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 w-full block"
              >
                Become a Member
              </a>
            </div>
